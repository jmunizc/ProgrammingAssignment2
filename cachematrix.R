...
## If that inverted matrix has already been calculated, then it
## will return a cache value, otherwise, it will calculate it.

## makeCacheMatrix takes a matrix x and creates a special "matrix"
...
## above function. However, it first checks to see if the inverse
